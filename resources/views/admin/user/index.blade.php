                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4 col-sm-12">
                            <select class="form-control" name="field" id="filter-field">
                                ...
                                <option data-type="input" {{  request()->field  ==  'email'      ? 'selected' : '' }} value="email">E-mail</option>
                                <option data-type="input" {{  request()->field  ==  'created_at' ? 'selected' : '' }} value="created_at">Data</option>
                ...
                <div class="table-responsive fixed-solution">
                    <table class="table table-hover table-striped table-sm">
                        ...
                        <tr>
                            ...
                            <th><a href="{{ request()->fullUrlWithQuery(['column' => 'email',  'order'  => "$order" ]) }}"><i class="fas fa-sort"></i></a> E-mail</th>
